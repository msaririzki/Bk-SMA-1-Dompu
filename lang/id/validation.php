...
return [
    ...
    'attributes' => [
        ...
        'track' => 'Jurusan',
        'group_number' => 'Nomor rombongan belajar',
        'homeroom_teacher_id' => 'Wali kelas',
        'nip' => 'NIP',
        'role' => 'Peran akun',
        'is_active' => 'Status aktif',
        'levels' => 'Tingkat pelanggaran',
        'levels.*.id' => 'Tingkat pelanggaran',
        'levels.*.name' => 'Nama tingkat pelanggaran',
        'levels.*.min_points' => 'Poin minimum',
        'levels.*.max_points' => 'Poin maksimum',
        'category_id' => 'Kategori',
        'code' => 'Kode',
        'points' => 'Poin',
        'sanction' => 'Sanksi',
        'type' => 'Jenis',
        'identifier' => 'NIS, NISN, atau ID sementara',
        'scheduled_at' => 'Jadwal',
