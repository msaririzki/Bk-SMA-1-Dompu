...
<section class="mt-6 grid gap-4 lg:grid-cols-3">
    <div class="card-muted"><p class="text-sm font-extrabold text-navy-900">Unggah ulang tanpa data ganda</p><p class="mt-2 text-xs leading-5 text-slate-500">Perbaiki workbook lalu unggah kembali. ID sistem, NISN, atau NIS akan memperbarui siswa yang sama dan mempertahankan UUID beserta seluruh riwayatnya.</p></div>
    <div class="card-muted"><p class="text-sm font-extrabold text-navy-900">File review dapat dibatalkan</p><p class="mt-2 text-xs leading-5 text-slate-500">Sebelum dikonfirmasi, Super Admin dapat membuang file dan hasil analisisnya dengan verifikasi kata sandi. Tindakan ini tidak menghapus siswa.</p></div>
    <div class="card-muted"><p class="text-sm font-extrabold text-navy-900">Impor resmi dikunci</p><p class="mt-2 text-xs leading-5 text-slate-500">Batch yang sudah dikonfirmasi tidak dapat dihapus. Perbaikan berikutnya dicatat sebagai batch baru agar jejak audit tetap lengkap.</p></div>
</section>
