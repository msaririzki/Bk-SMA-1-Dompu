...
@section('content')
    ...
    <section class="container-page pb-4">
        <div class="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-navy-900 to-navy-800 px-6 py-10 text-white shadow-2xl shadow-navy-900/15 sm:px-10 lg:flex lg:items-center lg:justify-between lg:px-12"><div class="pointer-events-none absolute right-0 top-0 size-64 rounded-full bg-teal-400/10 blur-3xl"></div><div class="relative"><p class="text-xs font-bold uppercase tracking-[.16em] text-teal-300">Portal pribadi siswa</p><h2 class="mt-3 max-w-2xl text-2xl font-extrabold text-white sm:text-3xl">Lihat riwayat dan progres pelanggaran secara mudah.</h2><p class="mt-3 max-w-xl text-sm leading-6 text-slate-300">Masuk menggunakan NISN, NIS, atau kode sementara kelas X yang diberikan sekolah.</p></div><a class="btn btn-accent relative mt-7 shrink-0 lg:mt-0" href="{{ route('student.login') }}">Buka portal siswa <x-icon name="arrow-right" /></a></div>
    </section>
@endsection
